    ...
    <>
      <section className='max-w-6xl flex justify-center items-center flex-col m-auto'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form>
            {/* Name Input */}
            <input type="text" id='name' value={name} className='mb-6 w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out' disabled/>

            {/* Email Input */}
            <input type="email" id='email' value={email} className='mb-6 w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out' disabled/>
